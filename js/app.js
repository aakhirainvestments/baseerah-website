    ...
    el.innerHTML = `<div class="egrid">
      ...
      <div class="ec reveal">
        ...
        <div class="e-info">
          ...
          ${e.registration_link ? `<br/><a href="${e.registration_link}" class="btn btn-primary" style="margin-top:10px;font-size:11px;padding:8px 18px">Register</a>` : ''}
        </div>
      </div>`).join('')}
    </div>`;
  }
...
<div class="citems">
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    else if (isPage('donate.html'))  initDonate();
